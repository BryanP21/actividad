      ...
      <div class="row backCakes">
        <div class="col-md-8 offset-md-2 formCakes">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-7">
              <select id="listEmpleados" class="form-select" aria-label="Default select example" disabled>
                
                <?php session_start();
                echo'<option value="'.$_SESSION["idempleado"].'">'.$_SESSION["usuario"].'</option>'; ?>
              </select>
            </div>
          </div>
          <!-- fecha entrega -->
          ...
          <!-- seleccione cliente -->
          <div class="mb-3 row d-none" id="infoDirecciones">
              <div class="col-md-4 text-end">
                <label for="listDirecciones" class="col-md-2 col-form-label"> Direcciones <i class="bi bi-plus-circle" onclick="addAddress()"></i></label>
              </div>
              <div class="col-md-7">
                <select id="listDirecciones" class="form-select " aria-label="Default select example">
          ...
          <div class="mb-3 row d-none" id="infoCliente">
              <div class="col-md-5 offset-md-1">
                <div class="mb-3 row">
                  ...
                  <div class="col-md-7">
                    <input type="text" readonly class="form-control form-control-plaintext" id="clienteCalle" value="">
                  </div>
                </div>
                <div class="mb-3 row">
                  <div class="col-md-4 text-end">
                  ...
                  <div class="col-md-7">
                    <input type="text" readonly class="form-control form-control-plaintext" id="clienteCiudad" value="">
                  </div>
                </div>
                <div class="mb-3 row">
                  <div class="col-md-4 text-end">
                  ...
                  <div class="col-md-7">
                    <input type="text" readonly class="form-control form-control-plaintext" id="clienteCodigoPostal" value="">
                  </div>
                </div>
                <div class="mb-3 row">
                  <div class="col-md-4 text-end">
                  ...
                  <div class="col-md-7">
                    <input type="text" readonly class="form-control form-control-plaintext" id="clienteNumeroExterior" value="">
                  </div>
                </div>
              </div>
              <div class="col-md-5 ">
                <div class="mb-3 row">
                  ...
                  <div class="col-md-7">
                    <input type="text" readonly class="form-control form-control-plaintext" id="clienteColonia" value="">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-7">
                    <input type="text" readonly class="form-control form-control-plaintext" id="clienteEstado" value="">
                  </div>
                </div>
                <div class="mb-3 row">
                  <div class="col-md-4 text-end">
                  ...
                  <div class="col-md-7">
                    <input type="text" readonly class="form-control form-control-plaintext" id="clienteDescripcion" value="">
                  </div>
                </div>

                <div class="mb-3 row">
                  <div class="col-md-11 text-end">
                    <button class="btn btn-primary d-none" onclick="guardarDireccion()" id="btnGuardarDireccion">Guardar dirección</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="mb-3 row">
            <div class="col-md-4 offset-md-8 text-end ">
              ...
              <div class="modal fade" id="modalProductos" tabindex="-1" role="dialog" aria-labelledby="modalProductosLabel" aria-hidden="true">
                <div class="modal-dialog margenAdd" role="document">
                  <div class="modal-content frmDim" >
